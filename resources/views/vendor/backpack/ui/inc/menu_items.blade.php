...
{{-- @role('admin') --}}
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('dashboard') }}"><i class="la la-home nav-icon"></i> User
        Wallet</a></li>
...
<x-backpack::menu-dropdown title="Business" icon="la la-business-time">
    ...
    <x-backpack::menu-dropdown-item title="Pending Approvals" icon="la la-clock" :link="backpack_url('pending-approvals')" />
